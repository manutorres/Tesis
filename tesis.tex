...
Multi-Agent Programming Contest 2011 (MAPC). El equipo d3lp0r estuvo compuesto
...
\cite{Rahwan:2009} \cite{Bench-Capon:2007}\ mediante programación lógica rebatible (DeLP
...
Como se verá en la sección REF, el comportamiento de los agentes está regido por 
el sucesivo planteo de situaciones deseables del mundo, y la búsqueda 
a largo plazo, es decir, prolongada en el tiempo, de alcanzar dichas situaciones. 
La existencia de un conjunto de estados deseables posibles, la información que el 
agente considera para determinarlos, y la selección de uno de ellos para adoptarlo 
como el próximo objetivok son conceptos introducidos por el modelo de creencias, deseos 
e intenciones (BDI). La sección \ref{sec:preliminaresBDI} presenta las principales 
...
para calcular éstos, entre otros usos. En la Fig. \ref{fig:mamarracho}, \texttt{esSeguro}, 
\texttt{\no esSeguro} y \texttt{dosSaboteadores} constituyen argumentos de Creencia.
