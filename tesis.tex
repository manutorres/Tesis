...
\newcommand{\SyA}{\mbox{\SSet\ $\cup$ \Arg}}
...
a cierta longitud, y, además, los caminos largos pero válidos generan un peso menos que 
los caminos cortos, para priorizar estos últimos.
...
reparar(Valor, Agente) -<
    ...
    valorReparar(Turnos, EnergiaRestante, PuntosRol, Salud, MaximaSalud, 
    	PuntosDeshabilitado, Valor).
\end{verbatim}
