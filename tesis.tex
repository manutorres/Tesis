...
Utilizando la misma idea que la funciones aritméticas de la sección anterior, el
...
este valor simplemente se encontrará en vez de la variable \texttt{Peso}. Un 
...
La aplicación de la arquitectura planteada no solo demostró ser viable para el
