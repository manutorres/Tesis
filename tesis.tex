...
Se trata de argumentos basados en las reglas 
que representan creencias, explicadas en la sección \ref{sec:creenciasDelp}. 
...
implementadas a partir del predicado \texttt{is_a_built_in}, y calculadas por demanda en Prolog.
